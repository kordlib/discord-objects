...
internal object DispatchSerializer : JsonContentPolymorphicSerializer<Dispatch<*>>(Dispatch::class) {
    ...
    override fun selectDeserializer(element: JsonElement): DeserializationStrategy<out Dispatch<*>> {
        ...
        return when (
            ...
            EventName.GuildStickersUpdate -> TODO() //GuildStickersUpdate.serializer()
            EventName.GuildUpdate -> GuildUpdate.serializer()
            EventName.IntegrationsCreate -> TODO() //IntegrationsCreate.serializer()
            EventName.IntegrationsDelete -> TODO() //IntegrationsDelete.serializer()
            EventName.IntegrationsUpdate -> TODO() //IntegrationsUpdate.serializer()
            ...
            EventName.Resumed -> TODO() //Resumed.serializer()
            EventName.StageInstanceCreate -> TODO() //StageInstanceCreate.serializer()
            EventName.StageInstanceDelete -> TODO() //StageInstanceDelete.serializer()
            EventName.StageInstanceUpdate -> TODO() //StageInstanceUpdate.serializer()
