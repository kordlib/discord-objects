...
/**
 * Payload gotten from [GET /oauth2/applications/@me](https://discord.com/developers/docs/topics/oauth2#get-current-bot-application-information)
 */
@Serializable
data class ApplicationData(
    ...
    val owner: Optional<UserData> = Optional.Missing(),
    val summary: String,
