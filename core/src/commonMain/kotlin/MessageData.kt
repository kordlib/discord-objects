 ...
 * @param applicationId if the message is a response to an [Interaction][InteractionData], this is the id of the interaction's application
 * @param components a list of [components][ComponentData] which have been added to this message
 */
...
data class MessageData(
    ...
    val mentions: List<OptionallyMemberUserData>,
...
data class MessageFlags(val code: Int) {

    val flags get() = MessageFlag.values().filter { code and it.code != 0 }
