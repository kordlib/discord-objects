...
import dev.kord.discord.objects.optional.OptionalSerializer
 ...
 */
private object NotSerializable : KSerializer<Any?> {
...
class DiscordInteraction(
    ...
    private object MaybeMessageSerializer :
        KSerializer<Optional<DiscordMessage>> by OptionalSerializer(DiscordMessage.serializer()) {
        ...
        override fun deserialize(decoder: Decoder): Optional<DiscordMessage> {
            ...
            return if (
                ...
                decoder.json.decodeFromJsonElement(
                    OptionalSerializer(DiscordMessage.serializer()), element
                )
            }
        }
